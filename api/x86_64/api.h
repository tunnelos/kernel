...
inline void __api_setValues() {
    ...
    *(voidf*)&__desktop_add_task = (voidf)0xffffffffffe09ab4;
    *(voidf*)&__desktop_terminate_task = (voidf)0xffffffffffe09b03;
    *(voidf*)&__desktop_render_tasks = (voidf)0xffffffffffe09b2b;
    *(voidf*)&__desktop_get_current_tasks = (voidf)0;
    *(voidf*)&__desktop_init = (voidf)0xffffffffffe09960;
    *(voidf*)&__encoder_fill_chartable = (voidf)0xffffffffffe0a0bc;
    *(voidf*)&__encoder_ascii2ct = (voidf)0xffffffffffe0a02d;
    ...
    *(voidf*)&__cli = (voidf)0xffffffffffe09ca0;
    *(voidf*)&__sti = (voidf)0xffffffffffe09ca2;
    ...
    *(voidf*)&modf = (voidf)0xffffffffffe09852;
    *(voidf*)&acos = (voidf)0xffffffffffe09645;
    ...
    *(voidf*)&__pic_eoi = (voidf)0xffffffffffe09db0;
    *(voidf*)&__pic_remap = (voidf)0xffffffffffe09de8;
    *(voidf*)&__pic_disable = (voidf)0xffffffffffe09cc0;
    *(voidf*)&__pic_mask = (voidf)0xffffffffffe09ee5;
    *(voidf*)&__pic_unmask = (voidf)0xffffffffffe09f43;
    *(voidf*)&__pic_get_irq_reg = (voidf)0xffffffffffe09fa4;
    *(voidf*)&__pic_get_irr = (voidf)0xffffffffffe0a005;
    *(voidf*)&__pic_get_isr = (voidf)0xffffffffffe0a019;
    ...
    *(voidf*)&__pit_init = (voidf)0xffffffffffe09bef;
    *(voidf*)&__pit_eoi = (voidf)0xffffffffffe09ca4;
    *(voidf*)&__placeholder_init = (voidf)0xffffffffffe11c26;
    *(voidf*)&__placeholder_unitype = (voidf)0xffffffffffe11c31;
    *(voidf*)&__rtc_init = (voidf)0xffffffffffe09cc7;
    ...
    *(voidf*)&__sort_counting = (voidf)0xffffffffffe0a0c7;
    *(voidf*)&__sse_init = (voidf)0xffffffffffe09150;
    *(voidf*)&__sse_save = (voidf)0xffffffffffe09183;
    *(voidf*)&stb_csample_uint8 = (voidf)0xffffffffffe10e2a;
    *(voidf*)&stb_csample_int = (voidf)0xffffffffffe10ec9;
    *(voidf*)&stb_csample_float = (voidf)0xffffffffffe10f76;
    *(voidf*)&stb_bilerp_uint8 = (voidf)0xffffffffffe11023;
    *(voidf*)&stb_bilerp_uint8_3 = (voidf)0xffffffffffe111fe;
    *(voidf*)&stb_bilerp_uint8_4 = (voidf)0xffffffffffe11426;
    *(voidf*)&stb_bilerp_float = (voidf)0xffffffffffe11648;
    *(voidf*)&stb_bilerp_float_3 = (voidf)0xffffffffffe11827;
    *(voidf*)&stb_bilerp_int = (voidf)0xffffffffffe11a55;
    ...
    *(voidf*)&srand = (voidf)0xffffffffffe09d4e;
    *(voidf*)&rand = (voidf)0xffffffffffe09d6c;
    *(voidf*)&TUNNEL_RANDOM = (voidf)0xffffffffffe106e0;
    *(voidf*)&__systemconf_init = (voidf)0xffffffffffe106d5;
    ...
    *(voidf*)&__tools_int_test = (voidf)0xffffffffffe09ca9;
    ...
    *(voidf*)&__uni_create = (voidf)0xffffffffffe1078b;
    *(voidf*)&__uni_delete = (voidf)0xffffffffffe10cca;
    *(voidf*)&__uni_find = (voidf)0xffffffffffe10db9;
    *(voidf*)&floorf = (voidf)0xffffffffffe097da;
    *(voidf*)&floord = (voidf)0xffffffffffe097fd;
    *(voidf*)&floorl = (voidf)0xffffffffffe0981f;
    *(voidf*)&__floattixf = (voidf)0xffffffffffe11c48;
    *(voidf*)&__fixxfti = (voidf)0xffffffffffe11c69;
}