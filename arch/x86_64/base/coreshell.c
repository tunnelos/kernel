...
void __coreshell_install_stage2() {
    ...
    while(1) {
        wait(1);
        __gui_drawInputBar((vector2d_t){1, 3}, "Test", 16);
        __gui_drawInputBar((vector2d_t){1, 4}, "Test123456789012ABC", 16);
    }   
}
...
void __coreshell_install_stage1()
{
    ...
    puts_gui("Do you want to format harddrive?", COLOR_BLACK, 1, 3);
